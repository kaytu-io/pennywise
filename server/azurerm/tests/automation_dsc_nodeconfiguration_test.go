...
func (ts *AzureTestSuite) TestAutomationDNSNodeconfiguration() {
	ts.SetupSuite()
	fmt.Println("Suite Setup")
	ts.IngestService("Automation", "eastus")
	fmt.Println("Automation ingested")

	usg, err := ts.getUsage("../../testdata/azure/automation_dsc_nodeconfiguration/usage.yaml")
	require.NoError(ts.T(), err)

	stat := ts.getDirCosts("../../testdata/azure/automation_dsc_nodeconfiguration", *usg)
